    ...
    return (
        <div style={{color: '#003152'}}>
            ...
            <div style= {{border: '1px solid #ECECEC', height: '360px', margin: '50px 35%'}}>
                ...
                <p className='text-center' style={{margin: '20px auto'}}>Forgot your password ?<a href='#' style={{color: '#7A30E3'}}><b> Reset Password </b></a> </p>
                <hr />
                <p className='text-center' style={{margin: '20px auto'}}>Don't have an account ? Click here to <a href='#' style={{color: '#7A30E3'}}><b>get started </b></a> </p>
            </div>
        </div>
    )
}
